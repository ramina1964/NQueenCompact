...
namespace NQueen.ConsoleApp.Commands
{
    public class HelpCommands
    {
        ...
        public static string NQUEEN_HELP_SOLUTIONMODE => @"  SOLUTIONMODE - Values one of the following: 0 - 'Single', 1 - 'Unique', 2 - 'All'";

        public static string NQUEEN_HELP_BOARDSIZE =>
            $"  BOARDSIZE    - Whole Numbers in the Range:  [1, 37] for 'Single', [1, 17] for 'Unique', [1, 16] for 'All' Solutions";

        public static string NQUEEN_SOLUTIONMODE => @"Values one of the following: 0 - 'Single', 1 - 'Unique', or 2 - 'All':";

        public static string NQUEEN_BOARDSIZE =>
        $"Whole Numbers in the Range:  [{Utility.MinBoardSize}, {Utility.MaxBoardSizeForSingleSolution}] for 'Single', " +
            $"[{Utility.MinBoardSize}, {Utility.MaxBoardSizeForUniqueSolutions}] for 'Unique', and " +
            $"[{Utility.MinBoardSize}, {Utility.MaxBoardSizeForAllSolutions}] for 'All Solutions':";
    }
}